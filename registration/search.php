...
<body>
<h1>Search here!</h1>
    <p>Fill in your name that you want to search then click <strong>Submit</strong> to search.</p>
...
<?php
    ...
    // Retrieve data
    $sql_select = "SELECT * FROM registration_tbl WHERE registration_tbl.name=name";
